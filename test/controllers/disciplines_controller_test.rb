...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { description: @discipline.description, name: @discipline.name, time_beg: @discipline.time_beg, time_end: @discipline.time_end }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { description: @discipline.description, name: @discipline.name, time_beg: @discipline.time_beg, time_end: @discipline.time_end }
    assert_redirected_to discipline_path(assigns(:discipline))
  end
